...
> **✅ Версия 1.2.0 (04.12.2025):** Улучшена установка sqlite3, исправлена настройка DNS через базу данных, улучшена диагностика TCP соединений для SSL серверов.
...
- **🔧 Улучшена установка зависимостей:**
  - Автоматическая установка sqlite3 для работы с базой данных x-ui
  - Улучшена установка всех необходимых пакетов
- **🔧 Исправлена настройка DNS:**
  - DNS теперь настраивается напрямую в базе данных x-ui
  - DNS сохраняется после перезапуска x-ui
  - Автоматическое определение наличия sqlite3
- **🔧 Улучшена диагностика:**
  - Исправлена проверка TCP соединений для SSL серверов
  - Используется несколько методов проверки (bash /dev/tcp, nc, telnet)
  - Более точное определение состояния серверов
  - Исправлена ошибка подсчета ошибок в логах
