...
- **Количество Non-RU серверов** (например: 3)
- Для каждого сервера:
  - **vless:// ссылку** - все настройки парсятся автоматически!
- **Стратегию балансировки** (если серверов >1):
  - 1 = random
  - 2 = leastPing
  - 3 = leastLoad

**Всё!** IP, UUID, Public Key, SNI, fingerprint, service name - всё распарсится из vless:// ссылки автоматически! 🎯
